...
<body style="background-color: white;">
    <div class="row no-gutters">
        ...
        <div class="col-sm-2" 
            ...
            <div style="background-color: #d0e2f5; color: rgb(26, 23, 23); padding: 15px; text-align: center; margin-bottom: 20px; font-weight: bold;">
                Admin Dashboard
            </div>
    ...
    <style>
        .active-link {
            background-color: #98c4f3; /* Slightly darker blue for active link */
            border-left: 4px solid rgb(255, 255, 255); /* White left border for active link */
